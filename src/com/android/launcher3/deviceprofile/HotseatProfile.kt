    ...
    companion object Factory {
        fun createHotseatProfile(
            ...
            val hotseatQsbHeight =
                if (isQsbVisible) res.getDimensionPixelSize(R.dimen.qsb_widget_height) else 0
            val hotseatQsbShadowHeight =
                if (isQsbVisible) res.getDimensionPixelSize(R.dimen.qsb_shadow_height) else 0
